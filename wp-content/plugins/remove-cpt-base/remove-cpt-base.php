...
class remove_cpt_base{
	...
	function auto_redirect_old(){
		global $post;
		if( is_single() && is_object( $post ) && isset( $this->rcptb_selected[ $post->post_type ] ) ){
